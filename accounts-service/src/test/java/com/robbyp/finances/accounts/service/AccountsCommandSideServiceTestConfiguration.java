...
import com.robbyp.finances.accounts.web.AccountsWebConfiguration;
...
public class AccountsCommandSideServiceTestConfiguration {
  ...
  public RestTemplate restTemplate(HttpMessageConverters converters) {
    ...
    List<? extends HttpMessageConverter<?>> httpMessageConverters = Arrays
      .asList(new MappingJackson2HttpMessageConverter());
